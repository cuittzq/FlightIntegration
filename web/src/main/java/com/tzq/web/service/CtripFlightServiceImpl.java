...
public class CtripFlightServiceImpl implements CtripFlightService {
    ...
    public CreateOrderRes createOrder(CreateOrderReq req) {
        ...
        createOrderReqVO.getRouting().setFromSegments(flightRoutingsVOMapper.segmentDTO2VOs(req.getRoutings().getFromSegments()));
        createOrderReqVO.getRouting().setRetSegments(flightRoutingsVOMapper.segmentDTO2VOs(req.getRoutings().getRetSegments()));
