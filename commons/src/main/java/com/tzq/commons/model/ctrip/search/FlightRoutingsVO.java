...
public class FlightRoutingsVO {
    ...
    private AirlineAncillariesVO airlineAncillaries;
    private RulesVO              rule;
    private List<SegmentVO>      fromSegmentVOS;
    private List<SegmentVO>      retSegmentVOS;
    ...
    public AirlineAncillariesVO getAirlineAncillaries() {
        return airlineAncillaries;
    }

    public void setAirlineAncillaries(AirlineAncillariesVO airlineAncillaries) {
    ...
    public List<SegmentVO> getFromSegmentVOS() {
        return fromSegmentVOS;
    }

    public void setFromSegmentVOS(List<SegmentVO> fromSegmentVOS) {
        this.fromSegmentVOS = fromSegmentVOS;
    }

    public List<SegmentVO> getRetSegmentVOS() {
        return retSegmentVOS;
    }

    public void setRetSegmentVOS(List<SegmentVO> retSegmentVOS) {
        this.retSegmentVOS = retSegmentVOS;
    }
}
